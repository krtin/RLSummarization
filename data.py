...
class Vocab(object):
  ...
  def __init__(self, vocab_file, max_size):
    ...
    #store ids for start and end decoding tokens, will be used when reinforce is turned on
    self.decode_start_id = self._word_to_id[START_DECODING]
    self.decode_end_id = self._word_to_id[STOP_DECODING]
    self.pad_id = self._word_to_id[PAD_TOKEN]
    self.unk_id = self._word_to_id[UNKNOWN_TOKEN]
