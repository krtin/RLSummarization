...
def attention_decoder(decoder_inputs, initial_state, encoder_states, enc_padding_mask, cell, initial_state_attention=False, pointer_gen=True, use_coverage=False, prev_coverage=None, prev_context=None, cov_rl=None, use_reinforce=False):
  """
  Args:
  ...
  with variable_scope.variable_scope("attention_decoder") as scope:
    ...
    if(use_reinforce):
        coverage = cov_rl
    if(prev_context is None): #is not None only after the first step in reinforce mode
    ...
    return outputs, state, attn_dists, p_gens, coverage, cov_rl, context_vector
